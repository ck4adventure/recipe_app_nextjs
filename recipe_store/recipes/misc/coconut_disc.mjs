...
const COCONUT_DISC = {
	...
	ingredients: [
		...
		{ qty: 90, unit: "milliliter", name: "sweetened-condensed-milk" },
	],
	directions: [
			...
			"Freeze for 3 hours to harden, the cut out rounds that will fit into tart bases"
	],
	notes: [
		"Any unused discs store well in the freezer"
	]
}

export default COCONUT_DISC;