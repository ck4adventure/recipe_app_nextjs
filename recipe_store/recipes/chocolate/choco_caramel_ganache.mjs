...
const CHOCO_CARAMEL_GANACHE = {
	id: "CHOCO_CARAMEL_GANACHE",
	...
	steps: [
		...
		"Add the salted butter and warm cream into the caramel",
		"Stir the caramel until smooth, then pour into a bowl and mix with a hand mixer until it has cooled",
		"Pour the caramel into the melted chocolate and mix the ganache for a minute or two with a hand-held stick blender",
		"Leave the ganache to set overnight at room temperature",
		"Add the ganache to a piping bag and pipe into the tart bases"
	]
}

export default CHOCO_CARAMEL_GANACHE;