...
const CHOCO_CHIP_COOKIE = {
	...
	ingredients: [
		{ qty: 227, unit: "gram", name: "plugra-euro-unsalted-butter", note: "2 sticks" },
		{ qty: 340, unit: "gram", name: "bread-flour" },
		{ qty: 1, unit: "teaspoon", name: "kosher-salt" },
		{ qty: 1, unit: "teaspoon", name: "baking-soda" },
		{ qty: 57, unit: "gram", name: "ch-caster-sugar" },
...
export default CHOCO_CHIP_COOKIE;