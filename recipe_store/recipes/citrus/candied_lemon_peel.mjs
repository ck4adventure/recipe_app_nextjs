...
const CANDIED_LEMON_PEEL = {
	id: "CANDIED_LEMON_PEEL",
	title: "Candied Lemon Peel",
	label: "candied lemon peel",
	ingredients: [
		{ qty: 6, unit: "whole", name: "lemon", note: "organic with good rinds" },
	...
	directions: [
		...
		"Using a vegetable peeler, remove the outer peel of each lemon, working from stem end to blossom end; think about following the longitude lines on a globe.",
		...
		"When the syrup hits 250ºF, immediately remove from the heat and pour the lemon peels onto the cooling rack, separating and straightening the pieces as quickly as you can with the spatula or two forks. Once cool, shake off any excess sugar and cover lightly with paper towels or a clean towel overnight.",
...
export default CANDIED_LEMON_PEEL;