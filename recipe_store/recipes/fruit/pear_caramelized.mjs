...
const CARAMELIZED_PEAR = {
	id: "CARAMELIZED_PEAR",
	title: "Caramelized Pear",
	label: "caramelized pear",
	ingredients: [
	...
	directions: [
		"Slice the vanilla pod down the middle and use a knife to scrape out the pulp",
				...
				"Cook for about 5 minutes until the pear starts to caramelize",
				"Leave to cool"
...
export default CARAMELIZED_PEAR;