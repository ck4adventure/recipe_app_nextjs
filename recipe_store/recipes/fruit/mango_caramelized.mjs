...
const CARAMELIZED_MANGO = {
	id: "CARAMELIZED_MANGO",
	title: "Caramelized Mango",
	label: "caramelized mango",
	ingredients: [
	...
	directions: [
		...
		"Melt the butter in a pan and add the brown sugar, the lemon and orange zest, and the vanilla pulp",
		"When it starts to caramelize, add the lemon juice and passion fruit juice",
		"Add the pieces of mango and cook for 3 minutes over a low heat"
	],
	notes: []
}

export default CARAMELIZED_MANGO;