...
const POACHED_QUINCE = {
	...
	steps: [
		...
		"Peel the quinces and slice each into 8 pieces",
		"Add the quince pieces and the rosewater to the ginger syrup",
		"Leave to simmer for 90 minutes",
		"The quinces are done when they are soft and have turned orange in color",
		"Using a skimmer or slotted spoon, remove the quinces from the syrup and place them on a plate to cool"
	],
	notes: [
	]
}

export default POACHED_QUINCE;