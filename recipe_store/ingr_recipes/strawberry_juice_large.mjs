...
const STRAWBERRY_JUICE_LARGE = {
	id: "STRAWBERRY_JUICE_LARGE",
	title: "Large Batch of Strawberry Fruit Juice",
	label: "strawberry juice",
	ingredients: [
		{ qty: 1100, unit: "gram", name: "strawberry", note: "defrosted if frozen" },
		{ qty: 250, unit: "gram", name: "ch-caster-sugar" },
	],
	steps: [
...
export default STRAWBERRY_JUICE_LARGE;