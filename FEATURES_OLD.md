...
BOOK
Book has a Title, required
Book has a Year Published
...
Recipe belongs to a book, and has a pg number of where it is found in the book
A Recipe belongs to an author through a book, inverse Author has many recipes
A book has many Recipes

#### Adding Recipes from the internet
Recipe has a Link, required
Recipe has Author(s), optional

#### Adding Recipes from Friends
Recipe has an Author

#### Adding Anonymous Recipes
Recipe has no identifying info, called Anonymous or Source Unknown
